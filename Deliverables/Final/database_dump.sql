...
--
-- Temporary view structure for view `avg_driver_ratings`
--

DROP TABLE IF EXISTS `avg_driver_ratings`;
/*!50001 DROP VIEW IF EXISTS `avg_driver_ratings`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `avg_driver_ratings` AS SELECT 
 1 AS `driver_id`,
 1 AS `name`,
 1 AS `avg_speed_rating`,
 1 AS `avg_friendliness_rating`,
 1 AS `num_ratings`*/;
SET character_set_client = @saved_cs_client;

--
-- Temporary view structure for view `avg_restaurant_ratings`
--

DROP TABLE IF EXISTS `avg_restaurant_ratings`;
/*!50001 DROP VIEW IF EXISTS `avg_restaurant_ratings`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `avg_restaurant_ratings` AS SELECT 
 1 AS `restaurant_id`,
 1 AS `name`,
 1 AS `avg_value_rating`,
 1 AS `avg_quality_rating`,
 1 AS `num_ratings`*/;
SET character_set_client = @saved_cs_client;
...
--
-- Temporary view structure for view `driver_info`
--

DROP TABLE IF EXISTS `driver_info`;
/*!50001 DROP VIEW IF EXISTS `driver_info`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `driver_info` AS SELECT 
 1 AS `driver_id`,
 1 AS `student_id`,
 1 AS `person_id`,
 1 AS `name`,
...
CREATE TABLE `driver_rating` (
  ...
  KEY `driver_speed_rating_idx` (`driver_speed_rating`),
  KEY `driver_friendliness_rating_idx` (`driver_friendliness_rating`),
...
INSERT INTO `driver_rating` VALUES (1,5,1),(4,5,NULL),(7,NULL,4),(10,5,4),(12,NULL,2),(13,NULL,5),(14,5,1),(19,5,1),(21,NULL,3),(22,NULL,2),(23,5,5),(27,1,1),(30,NULL,2),(35,1,3),(36,1,NULL),(37,3,NULL),(39,NULL,5),(41,3,NULL),(43,5,2),(46,NULL,1),(48,1,NULL),(50,4,2),(52,NULL,5),(56,5,3),(60,5,5),(62,NULL,3),(65,3,NULL),(66,3,5),(68,4,2),(71,3,3),(73,4,NULL),(74,NULL,3),(75,NULL,4),(77,1,NULL),(81,3,5),(83,NULL,2),(88,2,5),(89,2,5),(91,1,2),(93,1,1),(94,4,3),(97,4,NULL),(98,3,1),(101,3,NULL),(102,3,1),(105,3,3),(106,NULL,1),(107,NULL,5),(110,2,5),(114,1,1),(117,NULL,4),(119,2,NULL),(121,1,1),(122,NULL,2),(124,5,3),(127,4,NULL),(128,5,NULL),(130,2,2),(132,4,4),(134,3,NULL),(136,1,5),(138,5,1),(139,NULL,1),(140,NULL,1),(141,5,2),(144,NULL,1),(145,NULL,2),(147,3,NULL),(148,NULL,5),(151,4,1),(152,1,2),(154,3,4),(156,NULL,5),(158,4,2),(160,3,1),(162,3,NULL),(165,1,4),(166,1,NULL),(167,NULL,3),(170,4,NULL),(171,5,5),(173,4,NULL),(175,NULL,4),(176,5,2),(179,3,3),(180,2,2),(182,1,NULL),(183,5,1),(184,2,1),(187,2,1),(190,NULL,2),(191,2,NULL),(193,3,5),(195,1,1),(197,2,2),(198,NULL,2),(200,NULL,3),(203,NULL,4),(205,2,2),(206,NULL,2),(208,1,1),(210,NULL,1),(212,3,NULL),(214,NULL,5),(218,1,3),(219,NULL,5),(221,3,3),(223,5,5);
/*!40000 ALTER TABLE `driver_rating` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Temporary view structure for view `driver_reviews`
--

DROP TABLE IF EXISTS `driver_reviews`;
/*!50001 DROP VIEW IF EXISTS `driver_reviews`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW
4.648),(250,72,59,67,4,100,38.888,5.088),(251,3,51,6,7,62,33.602,5.147),(252,65,87,44,2,80,37.829,4.907),(253,54,4,17,2,9,49.821,4.781),(254,6,13,50,5,15,44.145,5.435),(255,99,98,42,2,75,42.413,4.768),(256,36,31,80,2,99,43.611,4.751),(257,91,73,24,2,23,34.007,5.443),(258,60,56,20,7,91,35.676,5.292),(259,95,37,17,1,99,32.371,4.951),(260,100,8,89,6,18,40.565,4.874),(261,30,39,74,8,6,39.563,5.578),(262,53,75,48,5,51,38.274,4.622),(263,100,73,28,3,79,42.237,5.071),(264,87,96,75,2,27,39.137,4.751),(265,64,79,7,4,28,39.787,5.031),(266,91,59,96,7,43,41.362,4.942),(267,38,67,42,1,39,45.522,4.882),(268,43,31,22,1,45,38.339,5.124),(269,9,26,45,4,48,41.045,4.887),(270,43,92,17,4,91,42.978,5.011),(271,60,74,46,2,81,41.112,4.793),(272,8,69,20,3,67,35.685,4.883),(273,12,38,58,3,4,40.581,4.949),(274,43,40,21,7,37,47.151,4.621),(275,95,28,34,7,78,42.253,4.749),(276,80,90,88,6,46,45.622,5.176),(277,67,81,11,3,45,48.641,4.649),(278,11,59,76,8,97,38.378,5.348),(279,37,83,61,3,9,43.062,5.311),(280,41,81,69,8,19,41.711,4.839),(281,59,66,27,8,53,42.674,5.03),(282,100,60,52,2,35,42.219,4.381),(283,22,47,18,6,17,46.355,5.399),(284,9,74,48,8,70,41.843,4.829),(285,41,25,86,3,54,37.059,5.15),(286,25,49,100,4,34,41.985,4.754),(287,57,23,39,7,32,42.288,4.903),(288,42,100,94,3,95,35.962,5.23),(289,58,22,43,1,84,37.387,4.757),(290,98,12,88,5,40,38.472,5.23),(291,17,58,99,2,23,40.421,5.215),(292,57,40,62,6,17,34.228,5.28),(293,3,13,45,5,24,41.558,5.429),(294,26,26,100,4,88,43.95,4.902),(295,1,21,28,4,72,38.121,5.221),(296,79,91,76,1,15,42.209,5.154),(297,54,11,17,4,89,38.844,4.991),(298,13,18,31,5,51,46.591,4.994),(299,74,47,62,5,47,39.407,5.103),(300,71,7,24,3,24,43.795,4.971),(301,98,51,41,2,78,42.907,5.262),(302,35,4,34,1,57,38.363,5.282),(303,89,77,76,5,43,40.069,4.743),(304,32,61,66,2,62,43.626,4.905),(305,44,97,2,6,53,42.273,4.939),(306,78,79,44,4,42,34.725,5.355),(307,71,94,31,4,57,34.295,5.293),(308,46,54,47,6,98,41.851,5.212),(309,62,76,6,7,41,36.815,5.077),(310,31,30,76,1,3,42.293,5.087),(311,95,44,81,6,24,48.25,4.981);
...
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `order_AFTER_INSERT` AFTER INSERT ON `order` FOR EACH ROW BEGIN
	insert into delivery (driver_id, vehicle_id) values(new.driver_id, 2);
END */;;
DELIMITER ;
...
CREATE TABLE `rating` (
  ...
  CONSTRAINT `valid_rating_type_check` CHECK ((`rating_type` in (_utf8mb4'driver',_utf8mb4'restaurant')))
) ENGINE=InnoDB AUTO_INCREMENT=226 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='Stores values and comments for all ratings, plus which type of rating it is.';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `rating` VALUES (1,1,'Driver was incredibly rude, but got the food here quickly','driver'),(2,2,'Restaurent was alright, but not great','restaurant'),(3,3,NULL,'restaurant'),(4,4,NULL,'driver'),(5,5,'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla erit controversia. Ita prorsus, inquam; Quae quo sunt excelsiores, eo dant clariora indicia naturae. Sed mehercule pergrata mihi oratio tua.','restaurant'),(6,6,NULL,'restaurant'),(7,8,NULL,'driver'),(8,9,NULL,'restaurant'),(9,11,NULL,'restaurant'),(10,13,'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Tum mihi Piso: Quid ergo? Quo modo autem philosophus loquitur? Scrupulum, inquam, abeunti; Duo Reges: constructio interrete. Nihil ad rem! Ne sit sane; Qui-vere falsone, quaerere mittimus-dicitur oculis se privasse;','driver'),(11,14,NULL,'restaurant'),(12,14,NULL,'driver'),(13,15,'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Quia nec honesto quic quam honestius nec turpi turpius. Duo Reges: constructio interrete.','driver'),(14,16,'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Cave putes quicquam esse verius. Traditur, inquit, ab Epicuro ratio neglegendi doloris. Sit sane ista voluptas. Torquatus, is qui consul cum Cn.','driver'),(15,16,NULL,'restaurant'),(16,17,NULL,'restaurant'),(17,18,NULL,'restaurant'),(18,20,NULL,'restaurant'),(19,20,NULL,'driver'),(20,21,'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Eademne, quae restincta siti? Deprehensus omnem poenam contemnet. Duo Reges: constructio interrete. Id Sextilius factum negabat. Atqui reperies, inquit, in hoc quidem pertinacem; Rationis enim perfectio est virtus;','restaurant'),(21,22,NULL,'driver'),(22,24,NULL,'driver'),(23,25,NULL,'driver'),(24,25,'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Omnia contraria, quos etiam insanos esse vultis. Suo enim quisque studio maxime ducitur. Duo Reges: constructio interrete. A mene tu?','restaurant'),(25,26,NULL,'restaurant'),(26,29,NULL,'restaurant'),(27,29,NULL,'driver'),(28,30,NULL,'restaurant'),(29,31,NULL,'restaurant'),(30,33,NULL,'driver'),(31,33,NULL,'restaurant'),(32,34,'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Tenent mordicus. Huius ego nunc auctoritatem sequens idem faciam. Hoc Hieronymus summum bonum esse dixit. Sed quid sentiat, non videtis.','restaurant'),(33,35,NULL,'restaurant'),(34,36,'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Immo alio genere; At certe gravius. Quippe: habes enim a rhetoribus; Sic consequentibus vestris sublatis prima tolluntur. An nisi populari fama? Et quidem, inquit, vehementer errat; Nonne igitur tibi videntur, inquit, mala?','restaurant'),(35,36,'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ratio enim nostra consentit, pugnat oratio. Erat enim Polemonis. Sed in rebus apertissimis nimium longi sumus. Duo Reges: constructio interrete. Que Manilium, ab iisque M. An tu me de L.','driver'),(36,38,NULL,'driver'),(37,39,'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Idem iste, inquam, de voluptate quid sentit? Sed fortuna fortis;','driver'),(38,39,NULL,'restaurant'),(39,40,NULL,'driver'),(40,40,NULL,'restaurant'),(41,41,'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Tamen a proposito, inquam, aberramus. Illa tamen simplicia, vestra versuta. Sed tamen intellego quid velit. Duo Reges: constructio interrete. Scisse enim te quis coarguere possit? Aliud igitur esse censet gaudere, aliud non dolere.','driver'),(42,41,NULL,'restaurant'),(43,42,'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Id enim natura desiderat. Quod ea non occurrentia fingunt, vincunt Aristonem;','driver'),(44,42,NULL,'restaurant'),(45,43,NULL,'restaurant'),(46,44,NULL,'driver'),(47,44,NULL,'restaurant'),(48,45,NULL,'driver'),(49,46,NULL,'restaurant'),(50,47,'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Si longus, levis dictata sunt. Iam enim adesse poterit. Quis istud possit, inquit, negare? Sic enim censent, oportunitatis esse beate vivere. Addidisti ad extremum etiam indoctum fuisse. Bonum patria: miserum exilium.','driver'),(51,48,NULL,'restaurant'),(52,48,NULL,'driver'),(53,49,NULL,'restaurant'),(54,50,'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Eaedem res maneant alio modo. Si quicquam extra virtutem habeatur in bonis. Eam stabilem appellas. Id mihi magnum videtur. Sed eum qui audiebant, quoad poterant, defendebant sententiam suam.','restaurant'),(55,51,NULL,'restaurant'),(56,52,NULL,'driver'),(57,53,NULL,'restaurant'),(58,54,NULL,'restaurant'),(59,55,NULL,'restaurant'),(60,55,'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Comprehensum, quod cognitum non habet? Si longus, levis; Cur tantas regiones barbarorum pedibus obiit, tot maria transmisit? Quid sequatur, quid repugnet, vident. Quod quidem nobis non saepe contingit. Duo Reges: constructio interrete.','driver'),(61,56,'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Quid de Platone aut de Democrito loquar? Est enim effectrix multarum et magnarum voluptatum. Duo Reges: constructio interrete. Negare non possum. De hominibus dici non necesse est.','restaurant'),(62,56,'Lorem ipsum dolor sit amet, consectetur adipiscing elit. An tu me de L. Nihil illinc huc pervenit. Dici enim nihil potest verius. Itaque ad tempus ad Pisonem omnes.','driver'),(63,57,NULL,'restaurant'),(64,58,NULL,'restaurant'),(65,59,'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Erat enim Polemonis. Quo igitur, inquit, modo? Bonum patria: miserum exilium. Non potes, nisi retexueris illa. Duo Reges: constructio interrete. Quorum altera prosunt, nocent altera. Quod quidem nobis non saepe contingit.','driver'),(66,62,NULL,'driver'),(67,62,NULL,'restaurant'),(68,63,'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Quod ea non occurrentia fingunt, vincunt Aristonem; Respondent extrema primis, media utrisque, omnia omnibus. Qui ita affectus, beatum esse numquam probabis; Quae cum dixisset, finem ille.','driver'),(69,65,NULL,'restaurant'),(70,66,NULL,'restaurant'),(71,66,NULL,'driver'),(72,67,NULL,'restaurant'),(73,68,NULL,'driver'),(74,69,NULL,'driver'),(75,71,NULL,'driver'),(76,72,'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed plane dicit quod intellegit. Sed vos squalidius, illorum vides quam niteat oratio. Praeteritis, inquit, gaudeo. Sed plane dicit quod intellegit.','restaurant'),(77,72,NULL,'driver'),(78,73,NULL,'restaurant'),(79,74,NULL,'restaurant'),(80,75,NULL,'restaurant'),(81,75,NULL,'driver'),(82,78,NULL,'restaurant'),(83,78,'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Quamquam tu hanc copiosiorem etiam soles dicere. Quod quidem iam fit etiam in Academia. Duo Reges: constructio interrete. Idem iste, inquam, de voluptate quid sentit? Quonam, inquit, modo? Nos vero, inquit ille;','driver'),(84,79,NULL,'restaurant'),(85,80,NULL,'restaurant'),(86,81,NULL,'restaurant'),(87,82,NULL,'restaurant'),(88,83,NULL,'driver'),(89,84,'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Non autem hoc: igitur ne illud quidem. Suo genere perveniant ad extremum; Duo Reges: constructio interrete. Avaritiamne minuis? Est enim effectrix multarum et magnarum voluptatum. Videsne quam sit magna dissensio? At certe gravius.','driver'),(90,85,'Da food was yummy','restaurant'),(91,85,NULL,'driver'),(92,86,NULL,'restaurant'),(93,87,NULL,'driver'),(94,88,NULL,'driver'),(95,88,'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Re mihi non aeque satisfacit, et quidem locis pluribus. Eam tum adesse, cum dolor omnis absit; Fortemne possumus dicere eundem illum Torquatum? Etiam beatissimum?','restaurant'),(96,89,NULL,'restaurant'),(97,90,NULL,'driver'),(98,91,'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Polycratem Samium felicem appellabant. Sed quod proximum fuit non vidit. Et quidem, inquit, vehementer errat; Cyrenaici quidem non recusant;','driver'),(99,91,NULL,'restaurant'),(100,92,NULL,'restaurant'),(101,92,NULL,'driver'),(102,96,NULL,'driver'),(103,96,NULL,'restaurant'),(104,98,NULL,'restaurant'),(105,100,NULL,'driver'),(106,101,NULL,'driver'),(107,202,NULL,'driver'),(108,202,NULL,'restaurant'),(109,204,'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nam ista vestra: Si gravis, brevis; Ille enim occurrentia nescio quae comminiscebatur;','restaurant'),(110,205,NULL,'driver'),(111,205,'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Traditur, inquit, ab Epicuro ratio neglegendi doloris. A mene tu? Quis enim redargueret? Duo Reges: constructio interrete. Falli igitur possumus. Non est ista, inquam, Piso, magna dissensio.','restaurant'),(112,206,NULL,'restaurant'),(113,207,NULL,'restaurant'),(114,209,NULL,'driver'),(115,210,NULL,'restaurant'),(116,212,NULL,'restaurant'),(117,213,NULL,'driver'),(118,213,'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Id mihi magnum videtur. Huius, Lyco, oratione locuples, rebus ipsis ielunior. Id mihi magnum videtur. Sed ad bona praeterita redeamus.','restaurant'),(119,214,NULL,'driver'),(120,215,'Food was alright and probably could have been cheaper.','restaurant'),(121,216,'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Quo tandem modo? Minime vero, inquit ille, consentit. Easdemne res? Duo Reges: constructio interrete. Honesta oratio, Socratica, Platonis etiam.','driver'),(122,217,NULL,'driver'),(123,217,NULL,'restaurant'),(124,218,NULL,'driver'),(125,221,NULL,'restaurant'),(126,222,NULL,'restaurant'),(127,222,NULL,'driver'),(128,223,NULL,'driver'),(129,223,NULL,'restaurant'),(130,224,NULL,'driver'),(131,225,NULL,'restaurant'),(132,225,'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Graccho, eius fere, aequal�? Age sane, inquam. Universa enim illorum ratione cum tota vestra confligendum puto.','driver'),(133,226,NULL,'restaurant'),(134,227,NULL,'driver'),(135,228,NULL,'restaurant'),(136,230,NULL,'driver'),(137,231,NULL,'restaurant'),(138,231,NULL,'driver'),(139,233,NULL,'driver'),(140,234,NULL,'driver'),(141,235,'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Et nemo nimium beatus est; Quid ait Aristoteles reliquique Platonis alumni? Hic ambiguo ludimur. Quae diligentissime contra Aristonem dicuntur a Chryippo.','driver'),(142,237,NULL,'restaurant'),(143,238,NULL,'restaurant'),(144,239,NULL,'driver'),(145,240,NULL,'driver'),(146,241,NULL,'restaurant'),(147,242,NULL,'driver'),(148,243,NULL,'driver'),(149,243,NULL,'restaurant'),(150,244,'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed in rebus apertissimis nimium longi sumus. Cur igitur, inquam, res tam dissimiles eodem nomine appellas? Quam nemo umquam voluptatem appellavit, appellat;','restaurant'),(151,244,NULL,'driver'),(152,245,'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ille incendat? Quae similitudo in genere etiam humano apparet. Ecce aliud simile dissimile. Duo Reges: constructio interrete. Nemo igitur esse beatus potest. Sic enim censent, oportunitatis esse beate vivere.','driver'),(153,246,NULL,'restaurant'),(154,247,NULL,'driver'),(155,247,'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Facile est hoc cernere in primis puerorum aetatulis. Quam ob rem tandem, inquit, non satisfacit? Ea possunt paria non esse. Nos commodius agimus. Ut id aliis narrare gestiant?','restaurant'),(156,248,NULL,'driver'),(157,249,'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Non est igitur voluptas bonum. Nobis aliter videtur, recte secusne, postea; Hoc tu nunc in illo probas. Hic ambiguo ludimur.','restaurant'),(158,249,NULL,'driver'),(159,250,NULL,'restaurant'),(160,251,NULL,'driver'),(161,252,NULL,'restaurant'),(162,253,NULL,'driver'),(163,254,NULL,'restaurant'),(164,255,'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ecce aliud simile dissimile. Pauca mutat vel plura sane; Erat enim Polemonis. Ergo, inquit, tibi Q. Duo Reges: constructio interrete. Videsne quam sit magna dissensio?','restaurant'),(165,256,NULL,'driver'),(166,257,NULL,'driver'),(167,259,NULL,'driver'),(168,259,'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Si longus, levis. Quorum sine causa fieri nihil putandum est. Quod iam a me expectare noli. Nihil opus est exemplis hoc facere longius.','restaurant'),(169,260,'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Haec para/doca illi, nos admirabilia dicamus. Est, ut dicis, inquit; Qui ita affectus, beatum esse numquam probabis; Duo Reges: constructio interrete. Esse enim, nisi eris, non potes. Que Manilium, ab iisque M.','restaurant'),(170,260,'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Si qua in iis corrigere voluit, deteriora fecit. Nihil opus est exemplis hoc facere longius. Haec quo modo conveniant, non sane intellego. Duo Reges: constructio interrete. Deprehensus omnem poenam contemnet.','driver'),(171,261,NULL,'driver'),(172,261,NULL,'restaurant'),(173,262,NULL,'driver'),(174,262,NULL,'restaurant'),(175,264,NULL,'driver'),(176,266,NULL,'driver'),(177,267,NULL,'restaurant'),(178,269,NULL,'restaurant'),(179,269,NULL,'driver'),(180,270,NULL,'driver'),(181,270,NULL,'restaurant'),(182,272,NULL,'driver'),(183,273,NULL,'driver'),(184,277,NULL,'driver'),(185,278,NULL,'restaurant'),(186,279,'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nihil illinc huc pervenit. Quo modo? Negat enim summo bono afferre incrementum diem. Duo Reges: constructio interrete. Quo modo?','restaurant'),(187,280,NULL,'driver'),(188,281,NULL,'restaurant'),(189,282,NULL,'restaurant'),(190,283,'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nam quid possumus facere melius? Memini me adesse P. Primum in nostrane potestate est, quid meminerimus? At certe gravius.','driver'),(191,284,NULL,'driver'),(192,285,NULL,'restaurant'),(193,285,'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Recte, inquit, intellegis. Sed in rebus apertissimis nimium longi sumus.','driver'),(194,292,NULL,'restaurant'),(195,292,NULL,'driver'),(196,293,'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Quis istum dolorem timet? Cupiditates non Epicuri divisione finiebat, sed sua satietate. Non laboro, inquit, de nomine. Quare attende, quaeso. Rationis enim perfectio est virtus;','restaurant'),(197,293,NULL,'driver'),(198,295,NULL,'driver'),(199,295,NULL,'restaurant'),(200,296,NULL,'driver'),(201,296,'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Gerendus est mos, modo recte sentiat. Bonum incolumis acies: misera caecitas. Venit ad extremum; Quid adiuvas?','restaurant'),(202,299,NULL,'restaurant'),(203,299,NULL,'driver'),(204,300,NULL,'restaurant'),(205,300,NULL,'driver'),(206,301,NULL,'driver'),(207,302,NULL,'restaurant'),(208,302,NULL,'driver'),(209,303,NULL,'restaurant'),(210,303,'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aliter enim explicari, quod quaeritur, non potest. Zenonis est, inquam, hoc Stoici.','driver'),(211,304,NULL,'restaurant'),(212,306,NULL,'driver'),(213,306,NULL,'restaurant'),(214,307,NULL,'driver'),(215,307,'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Comprehensum, quod cognitum non habet? Numquam facies. Estne, quaeso, inquam, sitienti in bibendo voluptas? Suo genere perveniant ad extremum; Aliter enim nosmet ipsos nosse non possumus. Duo Reges: constructio interrete.','restaurant'),(216,308,NULL,'restaurant'),(217,309,NULL,'restaurant'),(218,310,NULL,'driver'),(219,311,NULL,'driver'),(221,2,'Driver was kind of slow and didn\'t talk much','driver'),(222,1,'Meh','restaurant'),(223,215,'Fantastic Driver!\r\n\r\nBrought my food super quick and was super nice to boot!','driver'),(224,209,'AWESOME!','restaurant'),(225,219,'Quality was poor, but it was cheap. you get what you pay for.','restaurant');
/*!40000 ALTER TABLE `rating` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Temporary view structure for view `restaraunt_reviews`
--

DROP TABLE IF EXISTS `restaraunt_reviews`;
/*!50001 DROP VIEW IF EXISTS `restaraunt_reviews`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `restaraunt_reviews` AS SELECT 
 1 AS `date`,
 1 AS `restaurant_id`,
...
CREATE TABLE `restaurant_rating` (
  ...
  KEY `restaurant_value_rating_idx` (`restaurant_value_rating`),
  KEY `restaurant_quality_rating_idx` (`restaurant_quality_rating`),
...
INSERT INTO `restaurant_rating` VALUES (2,4,3),(3,NULL,3),(5,NULL,5),(6,2,1),(8,2,1),(9,NULL,3),(11,1,NULL),(15,5,NULL),(16,3,NULL),(17,5,1),(18,5,1),(20,4,3),(24,2,4),(25,2,NULL),(26,5,5),(28,5,NULL),(29,1,NULL),(31,NULL,5),(32,3,2),(33,2,5),(34,3,3),(38,5,3),(40,3,2),(42,NULL,2),(44,NULL,1),(45,1,3),(47,1,NULL),(49,1,NULL),(51,4,3),(53,1,2),(54,5,1),(55,2,5),(57,5,4),(58,1,NULL),(59,2,NULL),(61,5,1),(63,3,4),(64,NULL,4),(67,2,NULL),(69,3,5),(70,4,NULL),(72,5,NULL),(76,NULL,3),(78,1,3),(79,2,NULL),(80,3,3),(82,2,NULL),(84,1,4),(85,5,3),(86,4,1),(87,5,NULL),(90,4,2),(92,5,NULL),(95,3,1),(96,3,2),(99,NULL,2),(100,4,2),(103,4,5),(104,1,3),(108,NULL,3),(109,5,4),(111,4,4),(112,5,2),(113,4,5),(115,2,3),(116,4,NULL),(118,5,2),(120,3,3),(123,4,5),(125,3,4),(126,2,2),(129,1,NULL),(131,2,1),(133,3,NULL),(135,1,2),(137,5,2),(142,1,NULL),(143,2,2),(146,4,3),(149,2,NULL),(150,NULL,5),(153,1,1),(155,1,NULL),(157,5,2),(159,4,2),(161,5,NULL),(163,4,NULL),(164,1,5),(168,NULL,2),(169,NULL,1),(172,NULL,1),(174,2,4),(177,1,2),(178,3,5),(181,NULL,4),(185,3,2),(186,4,NULL),(188,3,1),(189,2,4),(192,5,2),(194,4,1),(196,5,NULL),(199,3,4),(201,4,NULL),(202,1,5),(204,4,4),(207,NULL,5),(209,NULL,5),(211,1,NULL),(213,4,NULL),(215,NULL,1),(216,NULL,1),(217,3,NULL),(222,3,3),(224,5,5),(225,5,2);
...
--
/*!50003 DROP PROCEDURE IF EXISTS `add_driver_rating` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `add_restaurant_rating` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8mb4 */ ;
...
--
-- Final view structure for view `avg_driver_ratings`
--
...
/*!50001 VIEW `avg_driver_ratings` AS select `order`.`driver_id` AS `driver_id`,`driver_info`.`name` AS `name`,round(avg(`driver_rating`.`driver_speed_rating`),2) AS `avg_speed_rating`,round(avg(`driver_rating`.`driver_friendliness_rating`),2) AS `avg_friendliness_rating`,count(distinct `order`.`order_id`) AS `num_ratings` from (((`driver_rating` join `rating` on((`driver_rating`.`rating_id` = `rating`.`rating_id`))) join `order` on((`rating`.`order_id` = `order`.`order_id`))) join `driver_info` on((`order`.`driver_id` = `driver_info`.`driver_id`))) group by `order`.`driver_id`,`driver_info`.`name` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `avg_restaurant_ratings`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `avg_restaurant_ratings` AS select `order`.`restaurant_id` AS `restaurant_id`,`restaurant`.`restaurant_name` AS `name`,round(avg(`restaurant_rating`.`restaurant_value_rating`),2) AS `avg_value_rating`,round(avg(`restaurant_rating`.`restaurant_quality_rating`),2) AS `avg_quality_rating`,count(distinct `order`.`order_id`) AS `num_ratings` from (((`restaurant_rating` join `rating` on((`restaurant_rating`.`rating_id` = `rating`.`rating_id`))) join `order` on((`rating`.`order_id` = `order`.`order_id`))) join `restaurant` on((`order`.`restaurant_id` = `restaurant`.`restaurant_id`))) group by `order`.`restaurant_id`,`name` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `driver_info`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `driver_info` AS select `driver`.`driver_id` AS `driver_id`,`driver`.`student_id` AS `student_id`,`student`.`person_id` AS `person_id`,`person`.`person_name` AS `name`,`driver`.`date_hired` AS `date_hired`,`student`.`graduation_year` AS `graduation_year`,`person`.`person_email` AS `email`,`person`.`cell` AS `license_number` from ((`driver` join `student` on((`driver`.`student_id` = `student`.`student_id`))) join `person` on((`student`.`person_id` = `person`.`person_id`))) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `driver_reviews`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `driver_reviews` AS select `delivery`.`delivery_time` AS `date`,`driver`.`driver_id` AS `driver_id`,`driver`.`name` AS `driver_name`,`rating`.`order_id` AS `order_id`,`customer`.`person_id` AS `customer_id`,`customer`.`person_name` AS `customer_name`,`driver_rating`.`driver_speed_rating` AS `speed`,`driver_rating`.`driver_friendliness_rating` AS `friendliness`,`rating`.`rating_comment` AS `comment` from (((((`driver_rating` join `rating` on((`driver_rating`.`rating_id` = `rating`.`rating_id`))) join `order` on((`rating`.`order_id` = `order`.`order_id`))) join `driver_info` `driver` on((`order`.`driver_id` = `driver`.`driver_id`))) join `person` `customer` on((`order`.`person_id` = `customer`.`person_id`))) join `delivery` on((`order`.`delivery_id` = `delivery`.`delivery_id`))) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
--
-- Final view structure for view `restaraunt_reviews`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `restaraunt_reviews` AS select `delivery`.`delivery_time` AS `date`,`order`.`restaurant_id` AS `restaurant_id`,`restaurant`.`restaurant_name` AS `restaurant_name`,`rating`.`order_id` AS `order_id`,`order`.`person_id` AS `person_id`,`person`.`person_name` AS `person_name`,`restaurant_rating`.`restaurant_value_rating` AS `value`,`restaurant_rating`.`restaurant_quality_rating` AS `quality`,`rating`.`rating_comment` AS `comment` from (((((`restaurant_rating` join `rating` on((`restaurant_rating`.`rating_id` = `rating`.`rating_id`))) join `order` on((`rating`.`order_id` = `order`.`order_id`))) join `restaurant` on((`order`.`restaurant_id` = `restaurant`.`restaurant_id`))) join `person` on((`order`.`person_id` = `person`.`person_id`))) join `delivery` on((`order`.`delivery_id` = `delivery`.`delivery_id`))) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
-- Dump completed on 2021-05-03 15:40:15
